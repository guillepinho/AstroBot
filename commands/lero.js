module.exports = {
    name: 'lero',
    description: 'mando um lero aleatório',
    execute(message, args) {
		const titulo = args.join(' ').toLowerCase();
        const tab0 = [
            'Caros amigos, ',
			'Por outro lado, ',
			'Assim mesmo, ',
		...
		message.channel.send('Ah... entendi, você quer que eu fale sobre ' + titulo + '?').then(
			setTimeout(function() {
				message.channel.send(tab0[parseInt(Math.random() * t)] + tab1[parseInt(Math.random() * t)] + 'de ' + titulo + ' ' + tab2[parseInt(Math.random() * t)] + tab3[parseInt(Math.random() * t)] + ' Analisando o tema de ' + titulo + ' ' + tab1[parseInt(Math.random() * t)] + tab2[parseInt(Math.random() * t)] + tab3[parseInt(Math.random() * t)] + tab0[parseInt(Math.random() * t)] + tab1[parseInt(Math.random() * t)] + tab2[parseInt(Math.random() * t)] + tab3[parseInt(Math.random() * t)]);
			}, 3000));
    }
};