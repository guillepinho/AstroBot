            ...
            if (dados !== 1) {
                if (imagemDeDado === true) {
                    message.channel.send('_rolando o dado..._')
                        ...
                        .then(
                            setTimeout(function() {
                                message.author.send({ embeds: [rollEmbed] });
                                message.author.send({ files: attachmentArray });
                            }, 2000));
                }
                else {
                    message.channel.send('_rolando o dado..._')
                ...
                message.channel.send('_rolando o dado..._')
                    ...
                    .then(
                        setTimeout(function() {
                            message.channel.send('Resultado enviado para o seu DM!');
                        }, 2000))
                    .then(
                        setTimeout(function() {
                            message.author.send({ embeds: [rollEmbed], files: [attachment] });
                        }, 2000));
